class ErrorMessage:
    messages: dict = {
        ...
        'ERR40': "Given executor class in command file '{cid}.yaml' does not extend from cmd_exec.CmdExecutor.",
        ...
        'ERR59': "Given executor class does not extend from cmd_exec.CmdExecuter lass.",
        ...
        'ERR71': "Given action class does not extend from cmd_exec.CmdAction class.",
